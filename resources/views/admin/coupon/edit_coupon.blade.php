            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('coupon.update') }}" id="myForm" method="post">
                                    @method('POST')
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class=" form-group col-sm-9 text-secondary">
                                            ...
                                            <input type="date" class="form-control" name="validate"
                                                value="{{ $coupons->validate }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Update Couppon" />
                                        </div>
                                    </div>
                                </form>
                            </div>
